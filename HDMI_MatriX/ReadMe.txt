========================================================================
   APLICACIÓN: HDMI_MatriX Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación HDMI_MatriX.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación HDMI_MatriX.
...
HDMI_MatriX.cpp
    ...
    Contiene el código para mostrar el formulario.

Form1.h
    Contiene la implementación de su clase de formulario y función 
    InitializeComponent().

AssemblyInfo.cpp
    Contiene atributos personalizados para modificar metadatos de ensamblado.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado HDMI_MatriX.pch y un archivo de tipos 
